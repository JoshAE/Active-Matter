 ...
 * Investigating properties of clusters*/
...
double y[N];
double vx[N];
double vy[N], xvector[(int)(N/2)],yvector[(int)(N/2)],dxvector[(int)(N/2)],dyvector[(int)(N/2)] , yold[N];
double Fx[N];
    ...
    for (i=1;i<=10000000; i++)
    {
        ...
        */
        ...
        if(i>iout) {
            ...
            sprintf(fname, "Movie/g2_%.0ld.png", i+100000000000);
            id = g2_open_gd(fname, wsizex, wsizey, g2_gd_png);
            g2_set_auto_flush(id, 0);
