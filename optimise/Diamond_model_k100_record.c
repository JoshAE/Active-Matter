...
//initialising particle positions
    ...
    for (i = 0; i < 10000/del_t; i++) {
        ...
        if (i >= iout) {
            ...
            sprintf(fname, "r2=0.5_Pe=50/g2_%ld.png", 10000000000 + i);
            ...
            for (a = 0; a < N; a += 4) {
                ...
                g2_pen(id, 19);
                g2_filled_circle(id, scale * x[a+2], scale * y[a+2], scale * r2);
                g2_filled_circle(id, scale * x[b+2], scale * y[b+2], scale * r2);
